...
const allQuestions = [
    ...
    { question: "Which of the following is a sign of a severe allergic reaction (anaphylactic shock)?", answers: ["Sneezing", "Rash on the arm", "Mild itching","Swollen lips and breathing difficulty"], correct: 3 },
    ...
    { question: "What is the primary purpose of a triangular bandage in first aid?", answers: ["To clean wounds", "To check pulse", "To support injured limbs", "To wrap around the head"], correct: 2 },
    { question: "Which action should be taken if someone is choking but still able to cough?", answers: ["Encourage them to keep coughing", "Give back blows immediately", "Perform abdominal thrusts", "Start CPR"], correct: 0 },
    { question: "What should you do first if you suspect someone has a broken bone?", answers: ["Move the injured limb", "Apply heat", "Massage the injury", "Immobilize the area"], correct: 3 },
    ...
    { question: "How should you treat a chemical burn to the eye?", answers: ["Rub the eye to relieve irritation", "Cover the eye with a bandage", "Rinse the eye continuously with clean water", "Apply an ointment"], correct: 2 },
    { question: "Which of the following is a sign of shock?", answers: ["High fever", "Nosebleed", "Blurred vision", "Rapid, weak pulse"], correct: 3 },
    ...
    { question: "What should you do if someone has a nosebleed?", answers: ["Tilt their head back", "Apply a warm cloth to the nose", "Lie them down flat", "Pinch the nostrils and lean forward"], correct: 3 },
    ...
    { question: "How do you recognize a choking infant?", answers: ["Unable to cough or make noise", "Crying loudly", "Breathing heavily", "Laughing continuously"], correct: 0 },
    ...
    { question: "What is the recommended method for treating a nosebleed?", answers: ["Tilt the head back", "Apply ice to the forehead", "Blow the nose hard", "Pinch the nose and lean forward"], correct: 3 },
    { question: "How should you treat a minor burn?", answers: ["Apply butter or oil", "Rub the burn with salt", "Cover the burn with a thick cloth", "Hold the burn under cool running water"], correct: 3 },
    ...
    { question: "How should you treat a sprained ankle?", answers: ["Apply heat immediately", "Keep walking on it", "RICE method: Rest, Ice, Compression, Elevation", "Massage the affected area"], correct: 2 },
    ...
    { question: "How should you treat a suspected fracture?", answers: ["Move the limb to check mobility", "Give the person painkillers", "Apply direct pressure on the bone", "Immobilize the area and call for help"], correct: 3 },
...
const kbatQuestions = [
    ...
    { question: "What should you do if a person is suspected of having a spinal injury after a fall?", answers: ["Move them to a sitting position", "Massage their back gently", "Encourage them to stand up slowly", "Keep their head and neck still"], correct: 3 },
    { question: "During a chemical burn, what is the most important action to take if you do not know the specific chemical involved?", answers: ["Cover with a clean bandage", "Apply a burn cream", "Neutralize with vinegar or baking soda", "Wash the area with water immediately"], correct: 3 },
    { question: "A person collapses and is unresponsive but breathing. What should you do next?", answers: ["Begin CPR immediately", "Leave them until help arrives", "Give them something to drink", "Place them in the recovery position"], correct: 3 },
    ...
    { question: "During a seizure, what is the most important thing you should avoid doing?", answers: ["Clear the area of dangerous objects", "Place something soft under their head", "Hold the person down", "Time the duration of the seizure"], correct: 2 },
    ...
    { question: "How should you respond if someone is experiencing a severe allergic reaction and has already used their EpiPen?", answers: ["Give them a glass of water", "Wait for the reaction to subside on its own", "Call emergency services immediately", "Lay them down flat"], correct: 2 },
];
